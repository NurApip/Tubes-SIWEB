...
<body class="h-screen flex items-center justify-center bg-gray-100">
    <div class="bg-white p-10 rounded-2xl shadow-xl w-full max-w-md">
        ...
        <form method="POST" action="<?php echo e(route('password.reset.verify')); ?>" class="space-y-6">
            <?php echo csrf_field(); ?>
        ...
        <form method="POST" action="<?php echo e(route('password.reset.resend')); ?>" class="text-center text-sm mt-6 text-gray-600">
            <?php echo csrf_field(); ?>
            Tidak terima kode?
...
<?php /**PATH C:\xampp\htdocs\FutsalHub\resources\views/auth/verify-reset-password-otp.blade.php ENDPATH**/ ?>