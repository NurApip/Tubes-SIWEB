...
<body class="h-screen flex bg-gray-100">
        ...
        <div class="w-full max-w-sm">
            ...
            <form id="login-form" action="/login" method="POST" class="space-y-5">
                ...
                <div class="text-right">
                    <a href="<?php echo e(route('password.forgot')); ?>" class="text-sm text-green-700 font-bold underline">
                        Lupa Password?
                    </a>
                </div>
            </form>
    ...
    <script>
        let isPhoneMode = <?php echo json_encode($isPhoneMode, 15, 512) ?>;
...
<?php /**PATH C:\xampp\htdocs\FutsalHub\resources\views/auth/login.blade.php ENDPATH**/ ?>