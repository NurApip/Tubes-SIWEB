        ...
        try {
            ...
            if (!$recaptchaResponse->successful() || !$recaptchaResponse->json('success')) {
                return back()
                    ...
                    ->withErrors(['g-recaptcha-response' => 'Verifikasi reCAPTCHA gagal atau kedaluwarsa. Silakan coba lagi.']);
            }
            ...
            return back()
                ->withInput($request->except(['password', 'password_confirmation', 'g-recaptcha-response']))
                ->withErrors(['g-recaptcha-response' => 'Layanan reCAPTCHA sedang tidak tersedia. Silakan coba lagi.']);
        }
