        ...
        <div class="bg-white p-4 rounded-[32px] shadow-sm border border-slate-200 group">
                ...
                @if($f->galeri->count() > 0)
                    <div class="mt-4 flex gap-2 overflow-x-auto pb-1">
                        @foreach($f->galeri as $foto)
                            <div class="relative shrink-0">
                                <img src="{{ asset('storage/' . $foto->path_foto) }}" class="w-16 h-14 object-cover rounded-xl border border-slate-200" alt="Galeri {{ $f->nama_lapangan }}">
